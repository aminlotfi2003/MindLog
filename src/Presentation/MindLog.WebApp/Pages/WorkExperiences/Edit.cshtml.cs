...
using MindLog.Application.Features.WorkExperienes.Commands.UpdateWorkExperiene;
...
public class EditModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync(Guid id, CancellationToken cancellationToken)
    {
        try
        {
            var details = await _mediator.Send(new GetWorkExperieneDetailsQuery(id), cancellationToken);
    ...
    public async Task<IActionResult> OnPostAsync(CancellationToken cancellationToken)
    {
        ...
        var dto = new UpdateWorkExperieneDto(
            Input.Id,
            Input.ProfileId,
            Input.Company,
            Input.RoleTitle,
        ...
        var command = new UpdateWorkExperieneCommand(
            dto.Id,
            dto.ProfileId,
            dto.Company,
            dto.RoleTitle,
        ...
        try
        {
            ...
            TempData["SuccessMessage"] = "سابقه کاری با موفقیت بروزرسانی شد.";
